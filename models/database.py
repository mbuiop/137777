...
class TrainingData(db.Model):
    ...
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
    # تغییر نام از metadata به data_metadata
    data_metadata = db.Column(db.Text, default='{}')
    
    def get_metadata(self):
        return json.loads(self.data_metadata) if self.data_metadata else {}
    
    def set_metadata(self, data):
        self.data_metadata = json.dumps(data)
